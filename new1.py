...
bg = ImageTk.PhotoImage(Image.open("D:\\new weather\\cccp.png"))
...
def getWeather():
    city=textfield.get()
    geoloactor = Nominatim(user_agent="geoapiExercises")
...
#--------------------------API CALL--------------------------
    ...
    photo1 = PhotoImage(file="icon/02d@2x.png")
    ...
    img=(Image.open(f"D:\\new weather\\icon\\{seconddayimage}@2x.png"))
    ...
    img = (Image.open(f"D:\\new weather\\icon\\{thirddayimage}@2x.png"))
    resized_image = img.resize((50, 50))
    ...
    img = (Image.open(f"D:\\new weather\\icon\\{fourthdayimage}@2x.png"))
    resized_image = img.resize((50, 50))
    ...
    img = (Image.open(f"D:\\new weather\\icon\\{fifthdayimage}@2x.png"))
    resized_image = img.resize((50, 50))
    ...
    img = (Image.open(f"D:\\new weather\\icon\\{sixthdayimage}@2x.png"))
    resized_image = img.resize((50, 50))
    ...
    img = (Image.open(f"D:\\new weather\\icon\\{seventhdayimage}@2x.png"))
    resized_image = img.resize((50, 50))
...
day2.place(x=10,y=5)
secondimage=Label(secondframe, bg="#282829", fg="red")
...
day3.place(x=10,y=5)
thirdimage=Label(thirdframe,bg="#282829",fg="red")
...
#seventh cell
seventhframe=Frame(root,width=75,height=115,bg="#282829")
